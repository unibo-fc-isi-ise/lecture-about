...
\begin{alertblock}{Required}
	\begin{itemize}
		...
		%
		\begin{itemize}
			\item useful resources: \ccite{} %ProgrammizJavaIO,Naftalin2006,Bloch2008, JavaCollectionsCheatsheets,Warburton2014, Lea1999,Oaks2004, Garg2004,Goetz2006}
...
\begin{frame}[c, allowframebreaks]{Sorts of Projects}
    ...
    \begin{block}{Classic \courseAcronym{} Project}
        ...
        \begin{itemize}
            ...
            \begin{multicols}{2}
				...
				\end{enumerate}
			\end{multicols}
            \item Previous projects in this category: \ccite{Sd2021ProjectGuessR,Sd2021ProjectCAHu}
    ...
    \begin{block}{Advanced \courseAcronym{} Project}
        ...
        \begin{itemize}
			...
			\end{enumerate}
            \item Previous projects in this category: \ccite{Sd2021ProjectZyzzyva}
    ...
    \begin{block}{Research \courseAcronym{} Project}
        ...
        %
        \begin{itemize}
            \item[eg] TuSoW\ccite{tusow-icccn2019}, LPaaS\ccite{lpaas-bdcc2}, tuProlog\ccite{2pkt-softwarex}
            \item Workflow:
            %
            \begin{enumerate}
            ...
            \end{enumerate}
            \item Previous projects in this category: \ccite{Sd2021ProjectTusowCSharpInterface}
    ...
    \begin{block}{Systematic Literature Review (SLR)}
        ...
        \begin{itemize}
            ...
            \item Previous projects in this category: \ccite{Sd2021ProjectEtcd}
