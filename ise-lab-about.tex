...
\begin{frame}[c, allowframebreaks]{Sorts of Projects}
    ...
    \begin{block}{Research \courseAcronym{} Project}
        Help us extending some research some research line of ours, by developing some research idea into prototype+empirical evaluation, 
		and possibly a paper
        %
        \begin{itemize}
            \item[eg] TuSoW\ccite{tusow-icccn2019}, LPaaS\ccite{lpaas-bdcc2}, tuProlog\ccite{2pkt-swx16}, JaKtA\ccite{Baiardi2024}
            \item Workflow:
            %
            \begin{enumerate}
