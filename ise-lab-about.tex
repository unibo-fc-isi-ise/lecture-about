...
% %
% \begin{enumerate}
% 	\item we elicit most fundamental mechanisms of IS
...
% 	\item we discuss projects / theses concerning
% 	\begin{itemize}
...
% 		\item robots $\rightarrow$ input sensors providing raw measurements (cameras, \textsc{Lisar}s, etc.)
...
% 	\begin{itemize}
% 		\item human beings $\rightarrow$ hands, feet, virtually any limb of our bodies, speech
...
%===============================================================================
\section{About Module 2}
%===============================================================================

%/////////
\begin{frame}[c]{History}
The module used to focus on practical counterparts of the theoretical notions introduced in module 1, 
by providing exercises on
\begin{enumerate}
	\item computational logic and logic programming,
	\item BDI agents and how to program them in Jason,
	\item symbolic planning and \textsc{STRIPS},
	\item miscellaneous topics (e.g. argumentation, explainable AI, etc.)
\end{enumerate}
\ldots \alert{in 15h of lectures}
\end{frame}
%/////////

%/////////
\begin{frame}[c]{The future}
Today we are migrating towards a big \alert{re-design} of the course, due to the activation of the new \alert{AI curriculum} of the ISI master programme
\begin{itemize}
	\item the course as a whole will be devoted to \alert{``Intelligent Agents''}
	\begin{itemize}
		\item there including \alert{agentic} (LLM-based) approaches
	\end{itemize}
	\item module 2 in particular will focus on the engineering of LLM-based agents and technologies
	\begin{itemize}
		\item material is in production
	\end{itemize}
\end{itemize}
\end{frame}
%/////////
...
%/////////
\begin{frame}[c]{The present}
This year, the module will cover:
\begin{enumerate}
	\item BDI agents and how to program them in Jason,
	\begin{itemize}
		\item as an example of ``classical'' agent-oriented programming
		\begin{itemize}
			\item (opposed to LLM-based approaches)
		\end{itemize}
	\end{itemize}
	\item symbolic planning and \textsc{STRIPS},
	\begin{itemize}
		\item as an example of ``exact'' planning
		\begin{itemize}
			\item  (opposed to LLMs' \emph{intuitive} reasoning)
		\end{itemize}
	\end{itemize}
	\item fundamentals of LLM-based agent technologies (API, tools, structured outputs, etc.)
	\begin{itemize}
		\item here I need your feedback to avoid overlapping other courses and produce good material
	\end{itemize}
\end{enumerate}
\ldots \alert{still fitting 15h of lectures}
\end{frame}
%/////////
...
\begin{alertblock}{Required}
	\begin{itemize}
		...
		\item[$\checkmark$] OO programming on the JVM (17+)
		%
		\begin{itemize}
		...
		\item[$\checkmark$] programming in Python (3.10.x)
		%
		\begin{itemize}
...
\begin{frame}[c,allowframebreaks]{About Lab Lectures}
    ...
    \begin{itemize}
        ...
        %
        \begin{itemize}
			\item `optional' = `their completion is not explicitly checked before the exam'
        ...
        \item Exercises are provided as Git repositories hosting software projects
        %
        \begin{itemize}
...
\label{slide:submissions}
    ...
    \begin{itemize}
		...
		%
        \begin{itemize}
            \item yet comments and solutions are \emph{only} provided via Git
            \item please avoid snippets or zips containing code
        \end{itemize}

		\medskip

        \item Your code should be pushed on the same \alert{Git repository} exercises have been cloned from
...
\begin{frame}[c, allowframebreaks]{Sorts of Projects}
    ...
    \begin{block}{Advanced \courseAcronym{} Project}
        Provide an implementation for some \alert{scientifically-relevant} MAS or agentic framework \alert{from the literature}
        %
        \begin{itemize}
            \item[eg] agent-based simulation/programming tool, LLM-based agentic framework, etc.
            \item Workflow:
            %
            \begin{enumerate}
    ...
    \begin{block}{Research \courseAcronym{} Project}
        Develop some research idea into prototype+empirical evaluation, 
		and possibly a paper
        %
        \begin{itemize}
            \item[eg] TuSoW\ccite{tusow-icccn2019}, tuProlog\ccite{2pkt-swx16}, JaKtA\ccite{Baiardi2024}
            \item Workflow:
            %
            \begin{enumerate}
            ...
            \end{enumerate}
            \item Previous projects in this category: \ccite{ClausesBonarrigo,GalassiKotlinbdi,GenAI4BDIPlanningBattistini}
            \item[!] Innovation is high here, but the activity is very constrained
            %
            \begin{itemize}
                \item design and implementation must be expert-level
                \item good software development practices (testing, CI/CD) are mandatory
